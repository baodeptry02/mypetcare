...
const AddPetNext = () => {
    ...
    // Generate a unique pet ID based on the user's pet count
              ...
              <div className="image-group">
                ...
                <form onSubmit={handleSubmit} className="grid-container grid-container1">
                    ...
                    <div>
                        ...
                        <button type="button" className="submit-pet" onClick={() => navigate(-1)}>Back</button>
                    </div>
                </form>
            </div>
            <ToastContainer />
            <div className="img-add-next-pet-thumbnail">
                <img src="https://app.petotum.com/assets/img/wp/petbg.png" alt="Pet Background" />
            </div>
        </div>
    );
