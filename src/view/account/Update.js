  ...
  return (
    <div style={{height: "100vh"}} className="update-account-page">
      <div className="container container-update" id="container">
        ...
        <div className="info-card" style={{marginLeft: "1000px", marginTop: "-430px"}}>
        <FontAwesomeIcon icon={faIdBadge} className="icon" style={{fontSize:"40px", color:"#ff4081", marginTop: "20px", marginBottom: "20px"}}/>
        <h2 style={{color: "#9500ff"}}>What info is shared with others?</h2>
        <p>This information is not public. Petotum only releases contact information for pet care provider and pet parent after a reservation is confirmed.</p>
      </div>
    </div>
  );
}
